...
test('Secure Public Access stack created', () => {
  ...
  const app = new cdk.App({
    context: {
      ...
      "SecurePublicAccess": {
        ...
        "internal": {
          "servers": "b-1.mycccluster.****.us-east-1.aws.confluent.cloud:9092"
        },
        "external": {
          "servers": "*.example.aklivity.io:9092",
  ...
  template.hasResourceProperties('AWS::AutoScaling::AutoScalingGroup', {
    ...
    VPCZoneIdentifier: [
      { "Ref": "ZillaPlusVpcZillaPlusPublicSubnet1Subnet99B6EB78" },
      { "Ref": "ZillaPlusVpcZillaPlusPublicSubnet2Subnet7E285396" },
    ]
  });
  ...
  template.hasResourceProperties('AWS::ElasticLoadBalancingV2::TargetGroup', {
    Port: 9092,
    Protocol: "TCP",
    VpcId: { "Ref": "ZillaPlusVpc59AC4C81" }
  });
