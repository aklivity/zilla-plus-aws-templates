...
interface MskExpressClusterVpcContext {
  cidr: string
}

interface MskExpressClusterSubnetsContext {
  public: MskExpressClusterSubnetContext,
  private: MskExpressClusterSubnetContext
}

interface MskExpressClusterSubnetContext {
  cidrMask: number
}

interface MskExpressClusterSaslProps {
  iam?: boolean,
  scram?: string
}

interface MskExpressClusterAuthenticationContext {
  unauthenticated?: boolean,
  sasl?: MskExpressClusterSaslProps,
  mtls?: Array<string>,
}

interface MskExpressClusterContext {
  vpc?: MskExpressClusterVpcContext,
  subnets?: MskExpressClusterSubnetsContext,
  authentication: MskExpressClusterAuthenticationContext;
}

export class MskExpressClusterStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    super(scope, id, props);

    // lookup context
    const context : MskExpressClusterContext = this.node.getContext(id);
