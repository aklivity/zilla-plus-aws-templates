...
test('MskExpressCluster stack created', () => {
  ...
  const stack = new MskExpressClusterStack(app, 'MskExpressCluster', {
    env: {
      account: '12345678',
      region: 'us-east-1'
    }
    ...
    template.hasResourceProperties('AWS::MSK::Cluster', {
        BrokerNodeGroupInfo:
        {
            ...
            [
                ...
                {
                    Ref: "ZillaPlusMskVpcZillaPlusMskPrivateSubnet3Subnet2EE1428B"
                }
            ],
